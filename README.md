...
local win = DiscordLib:Window("blox fruit script")

local serv = win:Server("Sazx hub blox fruit script ", "")

local Main = serv:Channel("Main hack")
...
Main:Toggle("fast attack normal",false,function(value)
_G.FastAttack = value
...
Main:Toggle("master attack",false,function(value)
_G.FastAttack = value --การที่คุณใช้มันมากจนเกินไปมีโอกาสเดังได้ละโดนเตะแบน
...
Main:Toggle("stats up kaitan",false,function(value)
...
Main:Button("Redeem All Code",function(a)
